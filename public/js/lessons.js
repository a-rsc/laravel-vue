...
var lessons = new Vue({
  ...
  data: {
    lessons: [{
      num: 1,
      title: 'JSfiddle.net',
      file: 'http://jsfiddle.net/a_rsc/eg76axmy/4/'
    }, {
      num: 2,
      title: '¡Hi, Vue!',
      file: 2
      ...
      num: '8b',
      title: 'Computed properties / methods',
      file: '8b'
    }, {
      num: 9,
      title: 'Métodos',
      ...
      num: 25,
      title: 'Componente parametrizables',
      file: 25
    }, {
      num: 26,
  ...
  methods: {
    getTextContent: function getTextContent(lesson) {
      return "Lecci\xF3n ".concat(lesson.num, ": ").concat(lesson.title);
    }
  }
});
/******/ })()
